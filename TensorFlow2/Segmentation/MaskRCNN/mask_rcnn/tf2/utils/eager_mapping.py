'''
This is the order of all var names in
the provided TF1 checkpoint. This is needed
for loading to TF2 eager, because eager mode
does not guarantee unique variable names without
explicit name assignment.
'''


resnet_vars = ['conv2d_11/kernel',
 'conv2d_12/kernel',
 'conv2d_13/kernel',
 'conv2d_14/kernel',
 'conv2d_15/kernel',
