...
rm -rf $BASEDIR/../results_tf2_64x_novo_carl_herring_$1
mkdir -p $BASEDIR/../results_tf2_64x_novo_carl_herring_$1
...
/shared/rejin/conda/bin/herringrun -n 64 -c /shared/rejin/conda \
    ...
    /shared/rejin/conda/bin/python  ${BASEDIR}/bind_launch.py  --direct_launch=${DIRECT_LAUNCH} --nproc_per_node=${NUM_GPUS} --nsockets_per_node=2 --ncores_per_socket=24 ${BASEDIR}/../mask_rcnn_main.py \
        ...
        --lr_schedule="cosine" \
        --model_dir="$BASEDIR/../results_tf2_64x_novo_carl_herring_$1" \
        ...
        --use_custom_box_proposals_op | tee $BASEDIR/../results_tf2_64x_novo_carl_herring_$1/train_eval.log
