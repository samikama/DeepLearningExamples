...
/opt/amazon/openmpi/bin/mpirun --allow-run-as-root --tag-output --mca plm_rsh_no_tree_spawn 1 \
    ...
    -x PATH \
    --oversubscribe \
    /home/ubuntu/anaconda3/envs/tensorflow2_latest_p37/bin/python /home/ubuntu/fsx/DeepLearningExamples/TensorFlow2/Segmentation/MaskRCNN//mask_rcnn_eval.py \
        --mode="eval" \
        --loop_mode="session" \
        --checkpoint="/home/ubuntu/fsx/DeepLearningExamples/TensorFlow2/Segmentation/MaskRCNN/results_session_1x/model.ckpt-14785" \
        --eval_samples=5000 \
        --log_interval=100 \
        ...
        --model_dir="/home/ubuntu/fsx/DeepLearningExamples/TensorFlow2/Segmentation/MaskRCNN/results_session_1x" \
