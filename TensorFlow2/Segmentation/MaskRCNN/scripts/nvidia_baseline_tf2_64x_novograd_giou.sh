...
/opt/amazon/openmpi/bin/mpirun --allow-run-as-root --tag-output --mca plm_rsh_no_tree_spawn 1 \
    ...
    --hostfile /shared/mzanur/hosts_64x \
    -N 8 \
    ...
    -x RDMAV_FORK_SAFE=1 \
    --oversubscribe \
    bash /shared/mzanur/DeepLearningExamples/TensorFlow2/Segmentation/MaskRCNN.giou/scripts/launcher.sh \
    python ${BASEDIR}/../mask_rcnn_main.py \
        --mode="train_and_eval" \
	--loop_mode="tape" \
	--box_loss_type="giou" \
        --checkpoint="/shared/mzanur/DeepLearningExamples/TensorFlow2/Segmentation/MaskRCNN.giou/weights/resnet/resnet-nhwc-2018-02-07/model.ckpt-112603" \
        --eval_samples=5000 \
        --log_interval=10 \
